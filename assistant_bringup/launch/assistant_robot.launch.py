...
def generate_launch_description() -> LaunchDescription:
    ...
    enable_robot_compute = LaunchConfiguration('enable_robot_compute')
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('named_places_params', default_value=default_named_places_params),
            ...
            DeclareLaunchArgument('enable_robot_compute', default_value='false'),
            ...
            Node(
                ...
                output='screen',
                condition=IfCondition(enable_robot_compute),
